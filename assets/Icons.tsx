...
export const IconWeb = (props: SVGProps<SVGSVGElement>) => (
  <svg
    fill="#ffffff"
    width="800px"
    height="800px"
...
export const IconUnplash = (props: SVGProps<SVGSVGElement>) => (
  <svg
    fill="#000000"
    width="800px"
    height="800px"
  ...
  >
    ...
    <span
      className="w-8 h-8 bg-gradient-radial from-blue-400 to-blue-500 rounded-full"
      style={{ content: "" }}
    ></span>
  </svg>
);
